...
func main() {
	...
	localBanWindowFilter := Filter.NewBanWindowFilter(100, 3600, 0.75, false) //创建容量为100，窗口有效时间为3600秒，相似度要求为0.75的封禁窗口
	systemBanWindowFilter := Filter.NewBanWindowFilter(100, -1, 0.75, false)  //-1为永久生效
